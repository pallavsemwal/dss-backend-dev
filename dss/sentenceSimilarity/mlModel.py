...
calamity_encoded_data = model.encode(calamity_sen['lesson'].tolist())
epidemic_encoded_data = model.encode(epidemic_sen['lesson'].tolist())
publicGathering_encoded_data = model.encode(publicGathering_sen.lesson.tolist())
rally_encoded_data = model.encode(rally_sen['lesson'].tolist())
